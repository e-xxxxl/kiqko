    ...
    <Col  md={9}>
        <div className="profile-main-part-area-inner bg-all-pages mb-0-see">
            ...
            <div className="all-seting-area-pass">
                    ...
                    <Button className="btn-upgrade btn-later font-segoeui" variant="primary">Cancel</Button>
                    </Col>
                    <Col md={6} className="pl-0 up-field">
                    <Button className="btn-upgrade btn-upgrade-now font-segoeui" variant="primary">Yes</Button>
                    </Col>
                    </Row>
                    </div>
