...
const EditBasics = () => {
  ...
  <Col xs={12} className="mb-4 text-center">
    <h4 className="text-primary fw-bold">Edit Profile Details</h4>
    <p className="text-muted">Complete your profile to improve your matches</p>
  </Col>
  ...
  <div className="page-wrapper-all">
    <div className="pageWrapper-inner mt-3 mt-md-4 basic-page basic-page-full">
      <form onSubmit={handleSubmit} className="needs-validation" noValidate>
              ...
              <div className="d-flex flex-wrap gap-2">
                {[
                  ...
                  <div key={race} className="form-check">
                    ...
                    />
                    <label className="form-check-label" htmlFor={race.replace(/\s+/g, '')}>
                      {race}
                    </label>
                  </div>
                ))}
        ...
        <div className="card mb-4 border-0 shadow-sm">
          <div className="card-header bg-light">
            <h5 className="mb-0 text-primary">Physical Attributes</h5>
          </div>
          <div className="card-body">
                ...
                <div className="d-flex flex-wrap gap-3">
                  {[
                    ...
                    <div key={type} className="form-check">
                      ...
                      />
                      <label className="form-check-label" htmlFor={type.replace(/\s+/g, '')}>
                        {type}
                      </label>
                    </div>
                  ))}
        ...
        <div className="card mb-4 border-0 shadow-sm">
          ...
          <div className="card-body">
            ...
            <div className="row g-4">
              <div className="col-md-6">
                <label className="form-label fw-semibold">Have Kids</label>
              ...
              <div className="col-md-6">
                <label className="form-label fw-semibold">Want Kids</label>
                <div className="d-flex flex-column gap-2">
                  {['Yes', 'No', 'Maybe', 'Undecided'].map(option => (
                    <div key={option} className="form-check">
                      ...
                      />
                      <label className="form-check-label" htmlFor={`w${option}`}>
                        {option}
                      </label>
                    </div>
                  ))}
        ...
        <div className="card mb-4 border-0 shadow-sm">
          <div className="card-header bg-light">
            <h5 className="mb-0 text-primary">Relationship Preferences</h5>
          </div>
          <div className="card-body">
            {/* Here For */}
            <div className="mb-4">
            ...
            {/* Relocate */}
            <div className="mb-4">
              <label className="form-label fw-semibold">Willing to Relocate</label>
              <div className="d-flex flex-wrap gap-3">
                {['No', 'Yes', 'Undecided'].map(option => (
                  <div key={option} className="form-check">
                    ...
                    />
                    <label className="form-check-label" htmlFor={`${option}r`}>
                      {option}
                    </label>
                  </div>
                ))}
